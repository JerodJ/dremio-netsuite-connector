...
@SourceType(value = "NetSuiteARP", label = "NetSuite",uiConfig = "netsuite-layout.json")
public class NetSuiteConf extends AbstractArpConf<NetSuiteConf> {
  private static final String ARP_FILENAME = "arp/implementation/netsuite-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.netsuite.NetSuiteDriver";
